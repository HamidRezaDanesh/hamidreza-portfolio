...
export default function ExperienceCard({
  ...
  return (
    <div className="relative pl-8 border-l-2 border-primary-200 dark:border-primary-800 pb-12 last:pb-0">
      {/* Timeline dot */}
      <div className={`absolute left-0 top-0 -translate-x-1/2 w-4 h-4 rounded-full ${
        isLatest 
          ? 'bg-primary-600 ring-4 ring-primary-200 dark:ring-primary-800' 
          ...
          <div>
            ...
            {companyUrl ? (
              <a
                ...
                className="inline-flex items-center gap-2 text-primary-600 dark:text-primary-400 font-semibold hover:underline group"
              >
                {company}
